...
const services = [
  {
    ...
    projects: ['পাঠ্যক্রম ও পাঠ্যপুস্তক', 'শিক্ষা প্রতিষ্ঠান প্রতিষ্ঠা', 'বৃত্তি কার্যক্রম', 'উচ্চতর গবেষণাকেন্দ্র', 'প্রযুক্তি প্রশিক্ষণ', 'মক্তবভিত্তিক শিক্ষা'],
  ...
  },
  {
    ...
    projects: ['জরুরি ত্রাণ-সহায়তা ', 'দুঃস্থ নারী ও শিশুদের স্বাস্থ্যসেবা', 'বৃক্ষরোপণ কার্যক্রম'],
  ...
  },
  {
    ...
    projects: ['মসজিদভিত্তিক কার্যক্রম', 'প্রকাশনা', 'ফ্যামিলি কাউন্সেলিং ', 'দাওয়াহ প্রশিক্ষণ'],

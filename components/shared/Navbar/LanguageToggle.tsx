...
const LanguageToggle = () => {
  ...
  // Update the toggle position based on current locale
  ...
  return (
    ...
    >
      {/* Sliding Circle */}
      <span
        className={`absolute top-1 w-8 h-8 bg-white rounded-full shadow-md transition-all duration-300 ${isBengali ? 'translate-x-12' : 'translate-x-0'}`}
      ></span>
